...
import { Mail, Phone, MapPin, Linkedin, Download, Cpu, Wrench, TrendingUp, Menu, X } from 'lucide-react'

const Section = ({id, title, children}) => (
  <section id={id} className="scroll-mt-20 max-w-6xl mx-auto px-4 md:px-6 py-14 md:py-20">
    <h2 className="text-2xl md:text-3xl font-extrabold mb-6 md:mb-8 text-center">{title}</h2>
    {children}
  </section>
)
    ...
    <div className="font-sans bg-white text-gray-900 scroll-smooth">
      ...
      <header className="sticky top-0 bg-white/90 backdrop-blur border-b z-50">
        <div className="max-w-6xl mx-auto flex justify-between items-center px-4 md:px-6 py-4">
          <h1 className="text-xl md:text-2xl font-bold tracking-tight">Neil Jose Pillard</h1>
          ...
          {/* Mobile menu button */}
          <button aria-label="Toggle menu" onClick={() => setOpen(v => !v)} className="md:hidden p-2 rounded-lg border hover:bg-gray-50">
        ...
        {open && (
          <div className="md:hidden border-t bg-white">
            <nav className="max-w-6xl mx-auto px-4 py-3 grid gap-3 text-sm font-medium">
      ...
      {/* Hero */}
      <section className="relative text-white py-20 md:py-32 text-center bg-gradient-to-r from-blue-300 via-blue-400 to-indigo-400">
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-transparent"></div>
        <div className="relative z-10 px-4">
          <h2 className="text-4xl md:text-6xl font-extrabold mb-4 md:mb-6 leading-tight">Engineer · Strategist · Innovator</h2>
          <p className="max-w-3xl mx-auto text-base md:text-xl opacity-95 leading-relaxed">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            <a 
              ...
              download 
              className="w-full sm:w-auto bg-white text-blue-900 px-5 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 shadow hover:bg-gray-100"
            >
              <Download className="h-5 w-5" /> Download CV
            </a>
            <a 
              href="#contact" 
              className="w-full sm:w-auto border border-white px-5 py-3 rounded-lg font-semibold text-white hover:bg-white/10"
            >
              Contact Me
            </a>
          </div>
      ...
      <Section id="about" title="About Me">
        <p className="max-w-3xl mx-auto text-center text-base md:text-lg leading-relaxed">
      ...
      <Section id="experience" title="Experience">
        <div className="grid md:grid-cols-2 gap-5 md:gap-8">
          <div className="p-5 md:p-6 border rounded-xl shadow hover:shadow-md transition bg-gray-50">
            <h3 className="font-semibold text-base md:text-lg mb-2">Operations & Strategy Leadership</h3>
          ...
          <div className="p-5 md:p-6 border rounded-xl shadow hover:shadow-md transition bg-gray-50">
            <h3 className="font-semibold text-base md:text-lg mb-2">Digital Product Management</h3>
          ...
          <div className="p-5 md:p-6 border rounded-xl shadow hover:shadow-md transition bg-gray-50">
            <h3 className="font-semibold text-base md:text-lg mb-2">Engineering & Automation</h3>
            <p className="text-sm opacity-80">Expertise in PLC, SCADA, HMI, VFD systems, robotics, and industrial automation.</p>
          </div>
          <div className="p-5 md:p-6 border rounded-xl shadow hover:shadow-md transition bg-gray-50">
            <h3 className="font-semibold text-base md:text-lg mb-2">Client & Vendor Engagement</h3>
      ...
      <Section id="skills" title="Skills">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto">
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><TrendingUp className="h-5 w-5 text-blue-600"/><span className="font-medium">Technical Leadership</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><TrendingUp className="h-5 w-5 text-blue-600"/><span className="font-medium">Strategic Operations</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><Cpu className="h-5 w-5 text-blue-600"/><span className="font-medium">Digital Transformation</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><Wrench className="h-5 w-5 text-blue-600"/><span className="font-medium">Product Development</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><Cpu className="h-5 w-5 text-blue-600"/><span className="font-medium">Industrial Automation</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><Cpu className="h-5 w-5 text-blue-600"/><span className="font-medium">PLC & SCADA Systems</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><Cpu className="h-5 w-5 text-blue-600"/><span className="font-medium">Robotics & Control</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><Cpu className="h-5 w-5 text-blue-600"/><span className="font-medium">Data Analysis</span></div>
          <div className="flex items-center gap-3 p-4 border rounded-xl shadow-sm bg-gray-50"><Wrench className="h-5 w-5 text-blue-600"/><span className="font-medium">Problem Solving</span></div>
        </div>
      </Section>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex flex-col items-start gap-2">
              ...
              <p className="flex items-center gap-2"><Linkedin className="h-5 w-5"/> <a href="https://linkedin.com/in/neilpillard" target="_blank" rel="noreferrer" className="underline">LinkedIn</a></p>
            </div>
